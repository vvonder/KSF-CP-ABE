...
#ifndef __LIBFENC_WATERSSIMPLECP_H__
#define __LIBFENC_WATERSSIMPLECP_H__

/*!
 *  Scheme-specific public parameters data structure.
 */

typedef struct _fenc_public_params_WatersSimpleCP {
	element_t gONE;
	element_t gTWO;
	element_t gaONE;
	element_t gaTWO;
...
} fenc_public_params_WatersSimpleCP;

/*!
 *  Scheme-specific group parameters parameters data structure.
 */

typedef struct _fenc_global_params_WatersSimpleCP {
...
typedef struct _fenc_secret_params_WatersSimpleCP {

	element_t alphaZ;
	element_t aZ;
} fenc_secret_params_WatersSimpleCP;

/*!
 *  Scheme-specific context data structure.
 */

typedef struct _fenc_scheme_context_WatersSimpleCP {
	fenc_global_params_WatersSimpleCP	*global_params;
	fenc_public_params_WatersSimpleCP	public_params;
	fenc_secret_params_WatersSimpleCP	secret_params;
} fenc_scheme_context_WatersSimpleCP;

/*!
 *  Scheme-specific ciphertext data structure.
 */

typedef struct _fenc_ciphertext_WatersSimpleCP {
...
} fenc_ciphertext_WatersSimpleCP;

/*!
 *  Scheme-specific decryption key data structure.
 */

typedef struct _fenc_key_WatersSimpleCP {
...
FENC_ERROR	libfenc_create_context_WatersSimpleCP(fenc_context *context);
...
FENC_ERROR	libfenc_gen_params_WatersSimpleCP(fenc_context *context, fenc_global_params *global_params);
...
FENC_ERROR	libfenc_set_params_WatersSimpleCP(fenc_context *context, fenc_public_params *public_params, fenc_secret_params *secret_params);
...
FENC_ERROR	libfenc_extract_key_WatersSimpleCP(fenc_context *context, fenc_function_input *input, fenc_key *key);
...
FENC_ERROR	libfenc_encrypt_WatersSimpleCP(fenc_context *context, fenc_function_input *input, fenc_plaintext *plaintext,
...
FENC_ERROR	libfenc_kem_encrypt_WatersSimpleCP(fenc_context *context, fenc_function_input *input, size_t key_len,
...
FENC_ERROR	libfenc_decrypt_WatersSimpleCP(fenc_context *context, fenc_ciphertext *ciphertext, fenc_key *key,
...
FENC_ERROR	libfenc_export_public_params_WatersSimpleCP(fenc_context *context, uint8 *buffer, size_t buf_len, size_t *result_len);
...
FENC_ERROR	libfenc_export_secret_params_WatersSimpleCP(fenc_context *context, uint8 *buffer, size_t buf_len, size_t *result_len);
...
FENC_ERROR	libfenc_import_public_params_WatersSimpleCP(fenc_context *context, uint8 *buffer, size_t buf_len, fenc_global_params *global_params);
...
FENC_ERROR	libfenc_import_secret_params_WatersSimpleCP(fenc_context *context, uint8 *buffer, size_t buf_len);
...
FENC_ERROR	libfenc_import_global_params_WatersSimpleCP(fenc_context *context, uint8 *buffer, size_t buf_len);
...
FENC_ERROR	libfenc_export_global_params_WatersSimpleCP(fenc_context *context, uint8 *buffer, size_t max_len, size_t *result_len);
 ...
 * @return				FENC_ERROR_NONE or an error code.
 */
FENC_ERROR  libfenc_export_secret_key_WatersSimpleCP(fenc_context *context, fenc_key *key, uint8 *buffer, size_t buf_len, size_t *result_len);
...
FENC_ERROR  libfenc_import_secret_key_WatersSimpleCP(fenc_context *context, fenc_key *key, uint8 *buffer, size_t buf_len);
...
FENC_ERROR	encrypt_WatersSimpleCP_internal(fenc_context *context, fenc_function_input *input, fenc_plaintext *plaintext,
...
FENC_ERROR	libfenc_destroy_context_WatersSimpleCP(fenc_context *context);
...
FENC_ERROR	libfenc_destroy_global_params_WatersSimpleCP(fenc_global_params *global_params);
...
FENC_ERROR libfenc_validate_global_params_WatersSimpleCP(fenc_global_params *global_params);
...
FENC_ERROR	libfenc_serialize_key_WatersSimpleCP(fenc_key_WatersSimpleCP *key, unsigned char *buffer, size_t max_len, size_t *serialized_len);
...
FENC_ERROR	libfenc_deserialize_key_WatersSimpleCP(fenc_key_WatersSimpleCP *key, unsigned char *buffer, size_t buf_len);
...
FENC_ERROR libfenc_serialize_ciphertext_WatersSimpleCP(fenc_ciphertext_WatersSimpleCP *ciphertext, unsigned char *buffer, size_t max_len, size_t *serialized_len);
...
FENC_ERROR libfenc_deserialize_ciphertext_WatersSimpleCP(unsigned char *buffer, size_t buf_len, fenc_ciphertext_WatersSimpleCP *ciphertext, fenc_scheme_context_WatersSimpleCP *scheme_context);
...
FENC_ERROR	fenc_ciphertext_WatersSimpleCP_initialize(fenc_ciphertext_WatersSimpleCP *ciphertext, fenc_attribute_list *attribute_list, fenc_attribute_policy* policy, FENC_CIPHERTEXT_TYPE type,
...
FENC_ERROR fenc_ciphertext_WatersSimpleCP_clear(fenc_ciphertext_WatersSimpleCP *ciphertext);
...
fenc_global_params_WatersSimpleCP*	initialize_global_params_WatersSimpleCP(fenc_group_params *group_params, fenc_global_params_WatersSimpleCP *global_params);
...
/*!
 * Clear the internals of a fenc_key_WatersSimpleCP structure.
 *
 * @param key_WatersSimpleCP			The fenc_key_WatersSimpleCP structure.
 * @return					FENC_ERROR_NONE or an error code.
 */

FENC_ERROR	fenc_key_WatersSimpleCP_clear(fenc_key_WatersSimpleCP *key_WatersSimpleCP);
...
FENC_ERROR	public_params_initialize_WatersSimpleCP(fenc_public_params_WatersSimpleCP *params, pairing_t pairing);
...
FENC_ERROR	secret_params_initialize_WatersSimpleCP(fenc_secret_params_WatersSimpleCP *params, pairing_t pairing);
...
FENC_ERROR	libfenc_fprint_ciphertext_WatersSimpleCP(fenc_ciphertext_WatersSimpleCP *ciphertext, FILE* out_file);

#endif /* ifndef __LIBFENC_WATERSSIMPLECP_H__ */